...
def setup():
    ...
    #create_joint_slider(-7, -2, 2, 0.01, 0, -0.5, 0.4, "Thumb Base Pose", update_hand, pose, betas, global_orient, transl)
    #create_joint_slider(-4, -2, 2, 0.01, 0, -0.5, 0.2, "Thumb Middle Pose", update_hand, pose, betas, global_orient, transl)
    #create_joint_slider(-1, -2, 2, 0.01, 0, -0.5, 0, "Thumb Tip Pose", update_hand, pose, betas, global_orient, transl)
    ...
    #create_joint_slider(11, -2, 2, 0.01, 0, -0.5, 0.4, "Middle Base Pose", update_hand, pose, betas, global_orient, transl)
    #create_joint_slider(14, -2, 2, 0.01, 0, -0.5, 0.2, "Middle Middle Pose", update_hand, pose, betas, global_orient, transl)
    #create_joint_slider(17, -2, 2, 0.01, 0, -0.5, 0, "Middle Tip Pose", update_hand, pose, betas, global_orient, transl)

    #create_joint_slider(29, -2, 2, 0.01, 0, -0.5, 0.4, "Ring Base Pose", update_hand, pose, betas, global_orient, transl)
    #create_joint_slider(32, -2, 2, 0.01, 0, -0.5, 0.2, "Ring Base Pose", update_hand, pose, betas, global_orient, transl)
    #create_joint_slider(35, -2, 2, 0.01, 0, -0.5, 0, "Ring Middle Pose", update_hand, pose, betas, global_orient, transl)

    create_joint_slider(20, -2, 2, 0.01, 0, -0.5, 0.4, "Pinky Base Pose", update_hand, pose, betas, global_orient, transl)
    create_joint_slider(23, -2, 2, 0.01, 0, -0.5, 0.2, "Pinky Middle Pose", update_hand, pose, betas, global_orient, transl)
    create_joint_slider(26, -2, 2, 0.01, 0, -0.5, 0, "Pinky Tip Pose", update_hand, pose, betas, global_orient, transl)
